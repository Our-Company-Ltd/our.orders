...
namespace our.orders.Helpers
{
    ...
    public class ApiResult
    {
        ...
        public static ApiResult FromIdentityResult(IdentityResult identityResult)
        {
            ApiResult result;
            if (!identityResult.Succeeded)
            {
                result = ApiResult.AsError(string.Join("\n", identityResult.Errors.Select(e => e.Description)));
                result.Errors.Add("IdentityErrors", identityResult.Errors.Select(e => e.Code + " " + e.Description).ToList());
            }
            else
            {
