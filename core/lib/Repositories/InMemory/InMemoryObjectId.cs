...
{
    public class InMemoryObjectId : IComparable<InMemoryObjectId>, IEquatable<InMemoryObjectId>, IConvertible
    {
        // private static fields
        private static readonly InMemoryObjectId __emptyInstance = default(InMemoryObjectId);
        ...
        public InMemoryObjectId(byte[] bytes)
        {
            if (bytes == null)
            {
        ...
        internal InMemoryObjectId(byte[] bytes, int index)
        {
        ...
        public InMemoryObjectId(DateTime timestamp, int machine, short pid, int increment)
        ...
        /// <param name="pid">The PID.</param>
        /// <param name="increment">The increment.</param>
        public InMemoryObjectId(int timestamp, int machine, short pid, int increment)
        {
        ...
        public InMemoryObjectId(string value)
        {
            if (value == null)
            {
        ...
        /// </summary>
        public static InMemoryObjectId Empty
        {
        ...
        public static bool operator <(InMemoryObjectId lhs, InMemoryObjectId rhs)
        {
        ...
        public static InMemoryObjectId GenerateNewId()
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static InMemoryObjectId GenerateNewId(DateTime timestamp)
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static InMemoryObjectId GenerateNewId(int timestamp)
        {
            int increment = Interlocked.Increment(ref __staticIncrement) & 0x00ffffff; // only use low order 3 bytes
            return new InMemoryObjectId(timestamp, __staticMachine, __staticPid, increment);
        }
        ...
        public static InMemoryObjectId Parse(string s)
        {
            if (s == null)
            {
        ...
        public static bool TryParse(string s, out InMemoryObjectId objectId)
        {
            ...
            if (s != null && s.Length == 24)
            {
                ...
                if (TryParseHexString(s, out bytes))
                {
                    objectId = new InMemoryObjectId(bytes);
                    return true;
                }
            }

            objectId = default(InMemoryObjectId);
            return false;
        }
        ...
        public int CompareTo(InMemoryObjectId other)
        {
        ...
        /// <param name="rhs">The other ObjectId.</param>
        /// <returns>True if the two ObjectIds are equal.</returns>
        public bool Equals(InMemoryObjectId rhs)
        {
            return
                _a == rhs._a &&
                _b == rhs._b &&
        ...
        {
            if (obj is InMemoryObjectId)
            {
                return Equals((InMemoryObjectId)obj);
            }
            else
            {
                return false;
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            switch (Type.GetTypeCode(conversionType))
            {
                ...
                case TypeCode.Object:
                    if (conversionType == typeof(object) || conversionType == typeof(InMemoryObjectId))
                    {
                        return this;
                    }
                    break;
