...
export const OrderItemFieldsMessages = defineMessages({
    empty: {
        id: 'src.components.forms.orderitem.empty',
        defaultMessage: '(no information)',
        description: 'Placeholder for empty order item'
    },
    title: {
    ...
    sku: {
        ...
        defaultMessage: 'SKU',
        description: 'Order item SKU (Stock Keeping Unit)'
    },
    description: {
    ...
    addSubitem: {
        ...
        description: 'Legend for add sub-item button'
    },
    lightboxTitle: {
